...
<?php if($account_limit === true) echo "<div class='message warning width-stretch'><h3>Your account limit as been reached (500 MB).</h3><p>You can free up space in your account by downloading some of your files and deleting them from your account.</p></div>"; // To export an ScPL file, right click on the file and click 'Export Shortcut'. You can convert the shortcut back to ScPL later once you've made space in your account for it. ?>
