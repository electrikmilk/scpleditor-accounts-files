...
<?php if($account_limit === true) echo "<div class='message warning width-stretch'><h3>Your account limit as been reached (500 MB).</h3><p>You can clear up space by exporting some of your ScPL files as shortcuts or you can download them instead, then delete the ScPL files to clear up space in your account. To export an ScPL file, right click on the file and click 'Export Shortcut'. You can convert the shortcut back to ScPL later once you've made space in your account for it.</p></div>"; ?>
