...
if ( $account[ 'status' ] === "0" )echo "<div class='message warning width-stretch'>Your account has not yet been activated. Please check your email. Be sure to check your junk/spam folder.</div>";
if ( $count[ 'total' ] !== 1 )$is = "s";
if ( $count[ 'files' ] !== 1 )$s = "s";
if ( $count[ 'folders' ] !== 1 )$fs = "s";
?>

<div class="message witch-stretch" id="settings-message" style="display: none;"></div>
