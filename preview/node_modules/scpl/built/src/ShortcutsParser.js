...
ParserHelper_js_1.o.newline = ParserHelper_js_1.p(ParserHelper_js_1.o.space, ParserHelper_js_1.plus(ParserHelper_js_1.p(ParserHelper_js_1.o.space, ParserHelper_js_1.or(ParserHelper_js_1.c `\n`, ParserHelper_js_1.c `;`))), ParserHelper_js_1.o.space).scb(_ => null);
...
ParserHelper_js_1.o.space = ParserHelper_js_1.p(ParserHelper_js_1.o.spaceonly, ParserHelper_js_1.optional(ParserHelper_js_1.o.multilineComment), ParserHelper_js_1.o.spaceonly, ParserHelper_js_1.optional(ParserHelper_js_1.o.eolComment)).scb(_ => null);
...
ParserHelper_js_1.o.namedargument, ParserHelper_js_1.o.value, ParserHelper_js_1.o.inputarg, ParserHelper_js_1.o.barlist, ParserHelper_js_1.o.argflag, ParserHelper_js_1.o.arglistparenthesis, ParserHelper_js_1.o.extendedarg, ParserHelper_js_1.o.errorparse
...
ParserHelper_js_1.o.inputarg = ParserHelper_js_1.p(ParserHelper_js_1.c `^`, ParserHelper_js_1.or(ParserHelper_js_1.o.parenthesis, ParserHelper_js_1.o.variable)).scb(([, paren]) => {
...
ParserHelper_js_1.o.dictionary = ParserHelper_js_1.p(ParserHelper_js_1.c `{`, _n, ParserHelper_js_1.star(ParserHelper_js_1.o.keyvaluepair).scb(items => items), _n, ParserHelper_js_1.c `}`).scb(([, , kvps], start, end) => new ParserData_js_1.DictionaryParse(start, end, kvps));
...
ParserHelper_js_1.o.parenthesis = ParserHelper_js_1.p(ParserHelper_js_1.c `(`, _n, ParserHelper_js_1.or(ParserHelper_js_1.o.action, ParserHelper_js_1.o.variable), _n, ParserHelper_js_1.c `)`).scb(([, , actionOrVariable]) => actionOrVariable);
