...
function parse(string, options) {
    ...
    try {
        ...
        throw new ParserData_1.PositionedError(`Error somewhere: ${er.toString()}`, [1, 1], [100, 1]);
    }
    if (!parsed.success) {
    ...
    let shortcut;
    try {
        shortcut = parsed.data.asShortcut(options.ccOverride || options.extraParseActions || undefined);
    }
    catch (er) {
        if (er instanceof ParserData_1.PositionedError) {
            throw er;
