...
var identifier = 'is.workflow.actions.encodemedia';
exports.identifier = identifier;
var icon = 'QuickTime';
exports.icon = icon;
var WFAction = {
  ActionClass: 'WFEncodeMediaAction',
  ActionKeywords: ['quicktime', 'render', 'audio', 'transcode', 'metadata', 'artwork', 'id3', 'video'],
  Description: {
  ...
  Parameters: [{
    ...
    Items: ['640x480', '960x540', '1280x720', '1920x1080', 'HEVC 1920x1080', 'HEVC 3840x2160', 'Passthrough'],
    Key: 'WFMediaSize',
    Label: 'Size',
    RequiredResources: [{
      WFParameterKey: 'WFMediaAudioOnly',
