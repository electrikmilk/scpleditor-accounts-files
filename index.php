...
<body>
	...
	<div class="modals-container">
		...
		<div class="modal" id="preview-dialog">
			...
			<div class="btn-group">
				<button type="submit" class="modal-btn primary-btn" onclick="modal('preview-dialog'),exportShortcut();">Export</button>
				<button type="submit" class="modal-btn" onclick="modal('preview-dialog');">Close</button>
			</div>
		</div>
